...
\begin{figure}[ht]
  ...
  \label{img:nube}
  \centering
  \subfloat[A partir de los títulos y resúmenes]{\includegraphics[width=0.45\textwidth]{abstracts_count_lemmatize}\label{img:nubef1}}
  \hfill
  \subfloat[A partir de las palabras claves]{\includegraphics[width=0.45\textwidth]{keywords_count_full}\label{img:nubef2}}
  \\
  {\footnotesize Fuente: de elaboración propia.}
\end{figure}
...
evaluar la incidencia que tiene un vídeojuego que se apoya en estrategias gamificadas y otro sin técnicas de 
